...
## 2. Why not lunr.js or algolia

algolia是第三方的服务，也是引入最简单、搜索效果最好的一种静态博客搜索方式，但algolia并不是慈善家，尽管有免费的额度使用，但免费额度的服务似乎已经下降了一个档次了，目前[官网价位表](https://www.algolia.com/pricing/)上显示免费账户拥有`10UNIT`的使用额度，而每`1UNIT`等于1000次搜索请求和1000条索引记录容量，个人认为免费服务看起来非常寒酸，有种受他人约束的感觉，故弃之。

lunr.js搜索中文的效果并不理想，更大的原因是每次搜索需要在本地下载、加载索引，由于JavaScript单线程的特性，加载时会导致网站卡顿，卡顿时间随着索引文件增大而延长，但好处是完全不依赖其他的服务，只要博客能访问搜索就能用，搜索结果不理想加上每次都必须的卡顿让我放弃了它。

## 3. Why vercel

vercel提供了云函数部署的功能，但这仅仅意味着vercel为我提供了免费的运行环境，核心的功能依旧是靠我的代码实现的，退一万步讲，哪天vercel倒了或者vercel不给我提供免费服务了，我顶多把函数再换个地跑，完全不会有其他的影响。
